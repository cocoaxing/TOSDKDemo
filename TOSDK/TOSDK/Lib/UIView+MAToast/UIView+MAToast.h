...
extern const NSString * MAToastPositionTop;
extern const NSString * MAToastPositionCenter;
extern const NSString * MAToastPositionBottom;
extern const NSString * MAToastPositionHigher;
extern const NSString * MAToastPositionLower;
@class MAToastStyle;
...
/**
 ...
 @param position The toast's center point. Can be one of the predefined MAToastPosition
...
/**
 `MAToastStyle` instances define the look and feel for toast views created via the
 `makeToast:` methods as well for toast views created directly with
 `toastViewForMessage:title:image:style:`.
 
 @warning `MAToastStyle` offers relatively simple styling options for the default
 toast view. If you require a toast view with more complex UI, it probably makes more
 sense to create your own custom UIView subclass and present it with the `showToast:`
 methods.
 */
@interface MAToastStyle : NSObject
...
/**
 Creates a new instance of `MAToastStyle` with all the default values set.
 */
- (instancetype)initWithDefaultStyle NS_DESIGNATED_INITIALIZER;

/**
 @warning Only the designated initializer should be used to create
 an instance of `MAToastStyle`.
 */
...
/**
 `MAToastManager` provides general configuration options for all toast
 notifications. Backed by a singleton instance.
 */
@interface MAToastManager : NSObject
...
/**
 ...
 with with a nil style. By default, this is set to `MAToastStyle`'s default
 style.
...
/**
 ...
 Default is `MAToastPositionBottom`.
 
 @param position The default center point. Can be one of the predefined
 MAToastPosition constants or a `CGPoint` wrapped in an `NSValue` object.
 */
+ (void)setDefaultPosition:(id)position;

/**
 Returns the default toast position. Default is `MAToastPositionBottom`.
